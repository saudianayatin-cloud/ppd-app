    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#your-table').DataTable({
                        ...
                        render: function(data, type, row, meta) {
                            return `
                                    <div class="action-stack">
                                        <button class="btn btn-warning btn-sm edit-btn" data-row="${meta.row}">
                                            <i class="fas fa-edit"></i> Upld
                                        </button>
                                        <button class="btn btn-sm btn-secondary files-btn" data-id="${row.stud_id2}">
                ...
                //Delete btn
                //   <br> <button style="margin-top: 1px;" class="btn btn-danger btn-sm btn-delete" 
